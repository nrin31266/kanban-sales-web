...
import { AuthModel, LoginRequest, LoginResponse } from "@/model/AuthenticationModel";
...
const Authenticate = () => {
  ...
  return isLoading ? (
    <div className="d-flex"  style={{justifyContent: 'center', width: '100%', height: '100vh', alignItems: 'center'}}>
      <div>
      <Spin indicator={<LoadingOutlined style={{ fontSize: 48, color: '' }} spin />} />
      </div>
    </div>
  ) : (
    <Empty
